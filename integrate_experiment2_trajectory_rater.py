"""Integrate official Flash Lite trajectory ratings into Experiment 2."""

from pathlib import Path

import integrate_flash_lite_trajectory_rater as integrator
...
def configure() -> None:
    ...
    integrator.RESPONSES_PATH = (
        ROOT
        / "data"
        / "experiment2_trajectory_rater_responses_gemini_3_1_flash_lite.md"
    )
